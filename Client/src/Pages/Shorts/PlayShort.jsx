...
const PlayShort = () => {
    ...
    useEffect(() => {
        ...
        if(selectedShort) {
            const selected = allShortsData.find((short) => short._id === selectedShort._id);

            const remaining = allShortsData.filter((short) => short._id !== selectedShort._id);
    ...
    <div className='h-screen w-full overflow-y-scroll snap-y snap-mandatory'>
        {
            ...
            <div key={short?._id} className='min-h-screen w-full flex md:items-center items-start justify-center snap-start pt-10 md:pt-0'>
                <div className='relative w-105 md:w-87.5 aspect-9/16 bg-black rounded-2xl overflow-hidden shadow-xl border border-gray-700 cursor-pointer mt-10 md:mt-0' onClick={() => togglePlay(index)}>
                    ...
                    <div className='absolute bottom-0 left-0 right-0 p-4 bg-linear-to-t from-black/80 via-black/40 to-transparent text-white space-y-1'>
